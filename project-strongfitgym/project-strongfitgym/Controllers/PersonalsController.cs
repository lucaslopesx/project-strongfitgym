...
namespace project_strongfitgym.Controllers
{
    public class PersonalsController : Controller
    {
        ...
        {
            return View(await _context.Personais.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("PersonalID,PersonalName,Especialidade")] Personal personal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PersonalID,PersonalName,Especialidade")] Personal personal)
        {
        ...
        {
            return _context.Personais.Any(e => e.PersonalID == id);
        }
    }
}
